...
const fadeBetweenViewsOverlay = document.getElementById("fade-between-views-overlay");
...
const enHomeViewDescription = document.getElementById("en-home-view-description");
...
const esHomeViewDescription = document.getElementById("es-home-view-description");

//// Home View - Video Cards
const homeViewVideoCardFlexbox = document.getElementById("home-view-video-card-flexbox");
const homeViewVideoCardPrototype = document.getElementById("video-card-prototype");
const enHomeViewVideoCardPrototype = document.getElementById("en-video-card-prototype");
const esHomeViewVideoCardPrototype = document.getElementById("es-video-card-prototype");
...
const videoPlayerReturnHomeBtn = document.getElementById("video-player-return-home-btn");
const videoPlayerPlaybackControls = document.getElementById("video-player-playback-controls");
const videoPlayerPlayPauseBtn = document.getElementById("video-player-play-pause-btn");
const videoPlayerPlayPauseBtnIcon = document.getElementById("video-player-play-pause-btn-icon");
...
const enVideoPlayerReturnHomeBtnTxt = document.getElementById("en-video-player-return-home-btn-txt");
const esVideoPlayerReturnHomeBtnTxt = document.getElementById("es-video-player-return-home-btn-txt");
...
export {
  ...
  enHomeViewDescription,
  esHomeViewDescription,
  // Home View
  homeView,
  toggleLangButton,
  enHomeViewTitle,
